...
fun getProcessedVideoLength(videoCount: Int): Long {
    var endValue = 0L
    for (i in 0..videoCount) {
        ...
        try {
            val fileTailFiltered = fileTail!!.split("=", ":") // Here we split the string above into different pieces
            val parsedSeconds = fileTailFiltered[7].split(".") // Parse seconds and milliseconds from the string above
            val time =
